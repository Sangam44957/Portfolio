...
export default function ThemeToggle() {
  ...
  const toggleTheme = () => {
    ...
    overlay.style.cssText = `
      ...
      z-index: 99999;
      pointer-events: none;
      background: ${newIsDark ? "#050505" : "#f5f5f7"};
  ...
  return (
    <motion.button
      ref={buttonRef}
      onClick={toggleTheme}
      className="fixed right-6 bottom-24 z-[9995] w-12 h-12 rounded-full flex items-center justify-center overflow-hidden group glass"
