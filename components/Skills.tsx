    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-sm font-mono text-nexus-text text-center">
            {skill.name}
          </span>
        ...
        >
          ...
          <span className="text-xs text-nexus-muted font-mono capitalize">
            {skill.category}
          </span>
        </div>
      </motion.div>
...
export default function Skills() {
  ...
  return (
    ...
    >
      <div ref={ref}>
        {/* Marquee - Infinite Scroll Tech Icons */}
          ...
          >
            {[...skills, ...skills].map((skill, i) => {
              ...
              return (
                <div
                  key={`${skill.name}-${i}`}
                  className="flex items-center gap-2 px-4 py-2 glass rounded-full shrink-0"
                >
                  <span style={{ color: skill.color }}>
                    <MarqueeIcon className="w-4 h-4" />
                  </span>
                  <span className="text-sm font-mono text-nexus-muted whitespace-nowrap">
                    {skill.name}
                  </span>
                </div>
              );
